...
const SideNav = ({data}) => {
    ...
    return (
        ...
        <div className='hidden md:block  w-[247px] h-[90vh] scrollbar-thin scrollbar-thumb-[#5DA9E9] scrollbar-track-[#EDEDED] overflow-y-scroll scrollbar-thumb-rounded-full'>
            {
